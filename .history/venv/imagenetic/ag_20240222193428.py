...
def one_point_crossover(elite, tam_pob):
    num_parents = len(elite)
    num_offspring = tam_pob - num_parents
    
    # Initialize an array to store offspring
    offspring = []
    ...
    for _ in range(num_offspring):
        ...
        # Determine crossover point along the height dimension
    ...
    # Pad the offspring to match the population size
    ratio = round(tam_pob / len(offspring))
    new_gen = np.array(offspring * ratio)
